  ...
  Widget build(BuildContext context) {
    return _SharedAxisTransitionSwitcher(
      defaultChild: Scaffold(
        ...
        bottomNavigationBar: Consumer<ProjectStore>(
          builder: (context, model, child) {
...
class _AnimatedBottomAppBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Selector<ProjectStore, bool>(
...
class _ReplyFabState extends State<_ReplyFab>
  ...
  void onPressed() {
    var onSearchPage = Provider.of<ProjectStore>(
      context,
      listen: false,
    ).onSearchPage;
